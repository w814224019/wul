...
function Hui_admin_tab(obj){
	...
	if(!href||href==""){
		console.log("data-href不存在，v2.5版本之前用_href属性，升级后请改为data-href属性");
		return false;
	}if(!title){
...
function creatIframe(href,titleName){
	...
	iframeBox.hide();
	iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe frameborder="0" th:src='+href+' src='+href+'></iframe></div>');
